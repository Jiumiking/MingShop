    ...
    <div class="container-fluid">		
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown visible-md visible-lg">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" src="<?php echo base_url('images/3.png');?>" alt="user-mail"><?php echo $this_user['name_real'];?></a>
