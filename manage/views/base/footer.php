<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
        ...
        <!-- page scripts -->
        <script src="<?php echo base_url('third_party/jquery-ui/js/jquery-ui-1.10.4.min.js');?>"></script>
        <script src="<?php echo base_url('third_party/touchpunch/jquery.ui.touch-punch.min.js');?>"></script>
        
        
        <!-- theme scripts -->
        <script src="<?php echo base_url('js/SmoothScroll.js');?>"></script>
        <script src="<?php echo base_url('js/jquery.mmenu.min.js');?>"></script>
